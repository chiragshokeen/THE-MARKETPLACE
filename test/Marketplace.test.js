...
contract('Marketplace',([deployer , seller  , buyer])=>{
    ...
    describe('products',async()=>{
        ...
        it('creates products',async()=>{
            ...
            await await marketplace.createProduct('iPhone13', 0, { from: seller }).should.be.rejected;
        ...
        it('sells products'  ,async()=>{
            ...
            oldSellerBalance = new web3.utils.BN(oldSellerBalance) //converting to Big Number
